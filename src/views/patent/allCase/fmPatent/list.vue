<template>
<!-- 规上工业企业发明专利覆盖率 -->
  <div class="workCommonListgs clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control">
			...
			<div class="form_control form_control2">
				<span>类型：</span>
				<el-radio v-model="applicant" label="1">覆盖率</el-radio>
  			<el-radio v-model="applicant" label="2">增长率</el-radio>
			</div>
...
const ziduandata =[
  ...
  export default {
    ...
    mounted() {
			...
			var option;
			var dataArr = ['2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020']
			var brokenData = [
				[12, 24, 23, 45, 76, 73, 89, 15, 4,51],
				[2, 4, 6, 3, 9, 10, 13, 15, 19,23],
				[5, 7, 3, 8, 12, 15, 17, 21, 26,33],
				[1, 2, 5, 7, 12, 11, 19, 21, 28,26],
				[1, 2, 3, 5, 8, 15, 17, 22, 21,25],
				[3, 4, 5, 7, 16, 19, 23, 33, 36,43],
				[1, 3, 4, 8, 11, 15, 19, 19, 22,16],
				[5, 1, 3, 6, 9, 15, 16, 21, 11,10]
			]
			option = {
					backgroundColor: '#100C2A',
					title: {
							text: '嘉兴市规上工业企业发明专利覆盖率'
					},
					tooltip: {
							trigger: 'axis',
							formatter: function(params, ticket, callback) {
								...
								for(var i=0;i<params.length;i++){
										...
										//名称
										var text = that.applicant==1?'覆盖率：':'增长率：';
										//值
										var value = params[i].data;
										showHtm+= name+ '--' + '&nbsp; &nbsp; 覆盖率：10%' + '&nbsp; &nbsp; 增长率：10%' +'<br>'
								}
								return showHtm;
							}
					},
