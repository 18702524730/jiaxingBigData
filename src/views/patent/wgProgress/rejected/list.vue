<template>
<!-- 商标权质押融资登记 -->
  <div class="workCommonList7 clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control form_control2">
			...
			<div class="form_control form_control2">
				<span>类型：</span>
				<el-radio v-model="applicant" label="1">商标权质押融资额度</el-radio>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'rejectedDetail', params: {id: item.caseSysNo,step:16}})
      },
