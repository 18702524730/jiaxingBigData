<template>
<!-- 证明商标、集体商标 -->
  <div class="workCommonList4 clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control form_control2">
			...
			<div class="form_control form_control2">
				<span>类型：</span>
				<el-radio v-model="applicant" label="1">证明商标</el-radio>
  			<el-radio v-model="applicant" label="2">集体商标</el-radio>
			</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'applyFeeDetail', params: {id: item.caseSysNo,step:13}})
      },
