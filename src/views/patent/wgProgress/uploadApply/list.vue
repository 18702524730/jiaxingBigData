<template>
<!-- 累计商标注册量同比环比分析 -->
  <div class="workCommonList1 clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control form_control2">
			...
			<div class="form_control form_control2">
				<span>类型：</span>
				<el-radio v-model="applicant" label="1">商标注册申请量</el-radio>
  			<el-radio v-model="applicant" label="2">商标注册量</el-radio>
			</div>
    ...
    series: [
        {
            name: '2019',
            type: 'bar',
            data: [320, 332, 301, 334, 390,343,354,364,375,343,232,423]
        },
        {
            name: '2020',
            type: 'bar',
             data: [454,656,676,687,797,565,654,756,865,567,656,545]
        },
        {
            name: '累计申请量',
            type: 'line',
            yAxisIndex:1,
            data: [10000, 11000, 11000, 31300, 41300, 51300, 61300,71300, 81300, 81300, 90300, 99300]
        }
    ]
};
...
option && myChart.setOption(option);
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'uploadApplyDetail', params: {id: item.caseSysNo,step:11}})
      },
    },
    filters: {
