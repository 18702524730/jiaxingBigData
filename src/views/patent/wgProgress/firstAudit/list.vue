<template>
<!-- 粮油及其他农产品商标注册 -->
  <div class="workCommonList5 clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control form_control2">
			...
			<div class="form_control form_control2">
				<span>类型：</span>
				<el-radio v-model="applicant" label="1">粮油</el-radio>
  			<el-radio v-model="applicant" label="2">其他农产品</el-radio>
			</div>
...
<script>
  ...
  export default {
			...
			option = {
					...
					series: [
							...
							},
							{
									...
									data: [454,656,676,787,897,565,654,756,865,567,656,545]
							}
					]
			};
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'firstAuditDetail', params: {id: item.caseSysNo,step:14}})
      },
