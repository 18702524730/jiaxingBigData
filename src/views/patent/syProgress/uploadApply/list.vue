<template>
<!-- 知识产权产业发展专题分析 -->
  <div class="workCommonList8 clientServiceOrder">
	  ...
	  <div class="condition clearfix">
	  	...
	  	<div class="form_control form_control2">
			...
			<div class="form_control">
				<el-input v-model="dataObj.applicant" placeholder="企业名称"></el-input>
			</div>
  ...
  export default {
    ...
    mounted() {
			...
			option = {
					...
					legend: {
							data: ['专利', '商标', '版权', '专利累计申请量', '商标累计申请量', '版权累计申请量'],
							// left: '0%',
							top: '5%',
					},
					xAxis: [
					...
					series: [
							...
							},
							{
									name: '版权',
									type: 'bar',
									data: [4, 9, 13, 23, 39, 45, 46, 56, 67,89]
							},
							{
									name: '专利累计申请量',
									type: 'line',
							...
							},
							{
									...
									type: 'line',
									yAxisIndex: 0,
									data: [4, 13, 26, 49, 88, 98, 105, 117, 125,153]
							}
					]
			};
    ...
    methods: {
      ...
      view(item){
      	this.$router.push({name: 'uploadApplyDetails', params: {id: item.caseSysNo,step:31}})
      },
    },
    filters: {
