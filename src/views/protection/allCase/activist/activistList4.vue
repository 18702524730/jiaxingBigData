  ...
  <div class="workCommonList clientServiceOrder">
		<div v-if="active==1">
			<div class="condition clearfix">
				<div class="title">商标侵权风险监测预警</div>
			</div>
			<div class="shuliangs">
				<div>
					<div class="title">嘉兴市注册商标总数</div>
					<div class="number">564件</div>
				</div>
				<div>
					<div class="title">嘉兴市商标注册企业数</div>
					<div class="number">4523家</div>
				</div>
				<div class="sbjc" @click="active=2">商标监测</div>
			</div>
			<table class="tables">
					<thead>
						<tr>
	  ...
	  <div v-if="active==2">
			<img @click="active=3" class="wids" src="~assets/img/active2.png" alt="">
		</div>
		<div v-if="active==3">
			<img class="wids" src="~assets/img/active3.png" alt="">
		</div>
  </div>
</template>
