<template>
<!--  专利状态变化监测预警 -->
  <div class="workCommonList10 clientServiceOrder">
	  <div v-if="active==1">
			<div class="condition clearfix">
				<div class="title">监测配置</div>
				<div class="contcen">
					<div>
						区域：
					...
					<div class="search">新增</div>
				</div>
			</div>
			<div class="tables">
				<div class="title">监测配置列表</div>
				<table>
					<thead>
						<tr>
							<th>序号</th>
					...
					<tbody>
						<tr>
							...
							<td>7天</td>
							<td>待实审</td>
							<td>lsf@cnsebe.com</td>
							<td><span>修改</span><span>删除</span><span @click="active=2">查看结果</span></td>
						</tr>
						<tr>
							<td>2</td>
							<td>待实审状态变化监测</td>
		...
		<div v-if="active==2" class="results">
			<div class="title">监测结果列表</div>
			<table>
				<thead>
					<tr>
						<th>申请人</th>
				...
				<tbody>
					<tr>
						<td>浙江长三角车联网安全技术有限公司</td>
						<td>一种智能网汽车信息安全风险评估方法及系统</td>
						<td>2020112573654</td>
						<td>CN205203245U</td>
						<td>2016-11-23</td>
						<td>2020-11-11</td>
