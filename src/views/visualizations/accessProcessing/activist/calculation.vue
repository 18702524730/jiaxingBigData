<template>
<!--   聚合和表计算 -->
  <div class="shujuList3 clientServiceOrder">
	  <div v-if="active==1" class="images">
			<img src="~assets/img/imageym3.png" alt="">
		</div>
...
.shujuList3{
	...
	.condition{
		...
		.form_control{
			float: left;width: 200px;display: inline-block;margin-right: 10px;margin-bottom: 10px;
			.el-radio{color: #fff;}
